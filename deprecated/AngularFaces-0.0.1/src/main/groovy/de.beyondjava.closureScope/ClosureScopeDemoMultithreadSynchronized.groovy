 ...
 *
 */
public class ClosureScopeDemoMultithreadSynchronized {
   public static void main(String[] args) {
      100.times{
         //         long start = System.nanoTime()
         List<Closure> closures = new ClosureScopeDemoMultithreadSynchronized().demo()
   ...
   public def demo() {
      ...
      11.times { int thread ->
         def closure =
         { synchronized(ClosureScopeDemoMultithreadSynchronized.class) {counter++; if (thread==0) println "$thread: $counter"  }}
