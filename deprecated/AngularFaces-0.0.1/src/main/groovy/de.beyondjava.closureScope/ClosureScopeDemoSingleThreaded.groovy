 ...
 *
 */
public class ClosureScopeDemoSingleThreaded {
   public static void main(String[] args) {
      100.times{
         long start = System.nanoTime()
         List<Closure> closures = new ClosureScopeDemoSingleThreaded().demo()
         closures[1..-1].each({new Thread(new ClosureScopeTester(it)).run() })
