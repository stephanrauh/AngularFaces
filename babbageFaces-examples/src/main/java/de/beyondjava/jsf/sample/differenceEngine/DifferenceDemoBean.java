...
public class DifferenceDemoBean implements Serializable {
	...
	public String changeCity() {
		String[] cities = new String[] { "Armsheim", "Biebelsheim",
				...
				"Gundersheim", "Hahnheim", "Immesheim", "Jugenheim",
				"Köngernheim", "Laubenheim", "Monsheim", "Oppenheim",
				"Pfeddersheim", "Q-City", "Rommelsheim", "Sossenheim",
				"Tattersheim", "Undenheim", "Vornheim", "Wermersheim",
				"X-City", "Ymmelsheim", "Zornheim" };
	...
	public void toggleFirstAndThirdSection(
