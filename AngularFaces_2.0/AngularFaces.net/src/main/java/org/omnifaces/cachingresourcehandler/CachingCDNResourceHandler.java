 ...
 * <p>
 * To configure the CDN URLs, a {@value org.omnifaces.cachingresourcehandler.CachingCDNResourceHandler#PARAM_NAME_CDN_RESOURCES}
 ...
 * parameter {@value org.omnifaces.cachingresourcehandler.CachingCDNResourceHandler#PARAM_NAME_CDN_DEV_STAGE} to <code>true</code>.
 * <pre>
 * &lt;context-param&gt;
 ...
 * <p>
 * If you're also using the {@link CachingCombinedResourceHandler}, then you need to understand that CDN resources can
 * simply not be combined, as that would defeat the CDN purpose. The {@link CachingCombinedResourceHandler} will therefore
 * automatically exclude all CDN resources from combining.
 *
 * @author Bauke Scholtz
 * @since 1.2
 */
public class CachingCDNResourceHandler extends ResourceHandlerWrapper {
	 ...
	 * based on the {@value org.omnifaces.cachingresourcehandler.CachingCDNResourceHandler#PARAM_NAME_CDN_RESOURCES} context
	 * parameter.
	 * @param wrapped The resource handler to be wrapped.
	 * @throws IllegalArgumentException When the context parameter is missing or is in invalid format.
	 */
	public CachingCDNResourceHandler(ResourceHandler wrapped) {
	 ...
	 * {@value org.omnifaces.cachingresourcehandler.CachingCDNResourceHandler#PARAM_NAME_CDN_RESOURCES} context parameter.
	 */
	@Override
