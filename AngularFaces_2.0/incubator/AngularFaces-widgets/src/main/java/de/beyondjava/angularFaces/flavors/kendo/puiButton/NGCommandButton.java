 ...
 * 
 */
@FacesComponent("de.beyondjava.kendoFaces.puiButton.PuiButton")
public class NGCommandButton extends UIInput {
    public static final String COMPONENT_FAMILY = "de.beyondjava.kendoFaces.puiButton.PuiButton";

//    /**
//     * Adds code to call the AngularJS model function and to intercept the server request if desired.
//     */
