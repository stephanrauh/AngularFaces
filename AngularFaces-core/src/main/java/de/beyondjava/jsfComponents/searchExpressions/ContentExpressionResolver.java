...
/**
 * Implementation of the SearchExpression @ngContent delivering the child nodes of the body tag. Useful for updating the
 * entire view without reloading stylesheet and Javascript.
 * 
