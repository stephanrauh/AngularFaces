...
public class NGSelectOneMenu extends org.primefaces.component.selectonemenu.SelectOneMenu implements
   ...
   String getNotificationJS() {
      ...
      String notification = "updateAngularModel(\"" + ngModel + "\", PrimeFaces.widgets." + widgetVar
            + ".getSelectedValue());";
      return notification;
   }
