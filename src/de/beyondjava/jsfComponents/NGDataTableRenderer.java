...
public class NGDataTableRenderer extends DataTableRenderer {
	 ...
	 * @author Stephan Rauh http://www.beyondjava.net
	 */
	public List<String> ngencodeMarkup(FacesContext context, UIComponent component)
			throws IOException {
		...
		originalWriter.append("<tr " + ngRepeat + ">\r\n");
	...
	private void replaceResponseWriter(FacesContext context,
		...
		ResponseWriter myWriter = new NGResponseWriter(writer,
				writer.getContentType(), writer.getCharacterEncoding(), rowVar);
		context.setResponseWriter(myWriter);
	}

	public String nggetTableDataAsJSScript(FacesContext context,
			UIComponent table) throws IOException {
		String jsObject = "";
